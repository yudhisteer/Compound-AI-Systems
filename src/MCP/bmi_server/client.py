    ...
    async with stdio_client(server_params) as (read, write):
        ...
        async with ClientSession(read, write) as session:
            ...
            try:
                ...
                result: types.CallToolResult = await session.call_tool(tool_call["tool"], arguments=tool_call["arguments"])
            ...
            # Success case: process the result as before
            ...
            # Get a natural language explanation from the LLM
